...
export const handler = async (event:APIGatewayEvent) =>{
    ...
    switch (resource){
        case '/v1/open': {
        return createResponse(200, { result: `${httpMethod} on open resource successful!`});
        }
        ...
        case '/v1/secure/{param}': {
            ...
            const param = getParam();
            return createResponse(200, { result: `${httpMethod} on secure resource with params: ${param} was successful!`});
        }
